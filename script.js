...
alert(
	"Welcome! You're facing off against the AI in Rock, Paper, Scissors.\n" +
		"First to win 3 rounds takes the game. Ties don't count.\n" +
		"Type your choice when asked — Cancel at any time to quit.",
);
...
function playRound(playerSelection, computerSelection) {
	...
	return winningMoves[playerSelection] === computerSelection
		? "playerWin"
		: "computerWin";
}
